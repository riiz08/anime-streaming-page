...
const Footer = () => {
  return (
    <div>
    <footer className="footer p-10 mt-20 bg-base-200 text-base-content">
  <div>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>Created by <a href="https://github.com/Riiz08">Muhamad Rizki</a><br/>Copyright © 2023 - All right reserved</p>
  </div> 
